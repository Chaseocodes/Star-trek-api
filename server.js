...
const aliens = {
    'humans': {
        'speciesName': 'Humans',
        'homeWorld': 'Earth',
        'features': 'Rounded ears, hair on head and face(somtimes)',
    ...
    'vulcans': {
        'speciesName': 'Vulcans',
        'homeWorld': 'Vulcan',
        'features': 'Pointed ears, upward pointed eyebrows',
        'interestingFact': 'Practice an extreme form of emotional regulation that focuses on logic above all else, pinoeered by a vulcan named Suarak',
    ...
    'klingons': {
        ...
        'homeWorld': "Qo'Nos",
        'features': 'Large stature, pronounced ridges on forehead, stylized facial hair',
        'interestingFact': 'Highly skilled in weapons and battle. Their facial ridfes were lost as the result of a virus in 2154, but were subsequently restored by 2269',
